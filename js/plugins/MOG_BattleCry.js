...
　　var Moghunter = Moghunter || {}; 	
	...
	//Moghunter.v_actor_start[5] = ["3la0001"];
	//Moghunter.v_actor_start[6] = ["3m0001"];
	// -----------------------------------------------------------------------
	// ACTOR - BATTLE TURN
	// -----------------------------------------------------------------------		
	...
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_default_action[2] = ["3s0001"];
	Moghunter.v_actor_default_action[3] = ["3l0001"];
	Moghunter.v_actor_default_action[4] = ["3n0001"];
	Moghunter.v_actor_default_action[5] = ["3la0001"];
	Moghunter.v_actor_default_action[6] = ["3m0001"];
	// -----------------------------------------------------------------------
	// ACTOR - SKILL
	// -----------------------------------------------------------------------	
	...
	// ACTOR - DAMAGE
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_damage[2] = ["3s0003"];
	Moghunter.v_actor_damage[3] = ["3l0003"];
	Moghunter.v_actor_damage[4] = ["3n0003"];
	Moghunter.v_actor_damage[5] = ["3la0003"];
	Moghunter.v_actor_damage[6] = ["3m0003"];
	// -----------------------------------------------------------------------
	// ACTOR - EVADED  &   MISS
	// -----------------------------------------------------------------------		
...
//	Moghunter.v_actor_recover[4] = ["P4_Recover_01"];
	...
	// ACTOR - DEAD
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_dead[2] = ["3s0004"];
	Moghunter.v_actor_dead[3] = ["3l0004"];
	Moghunter.v_actor_dead[4] = ["3n0004"];
	Moghunter.v_actor_dead[5] = ["3la0004"];
	Moghunter.v_actor_dead[6] = ["3m0004"];
	// -----------------------------------------------------------------------
	// ACTOR - ESCAPE
	// -----------------------------------------------------------------------		
...
//	Moghunter.v_actor_escape[4] = ["P4_Escape_01"];
	...
	// ACTOR - VICTORY
	// -----------------------------------------------------------------------		
	//Moghunter.v_actor_victory[2] = ["3s0005"];
	//Moghunter.v_actor_victory[3] = ["3l0005"];
	//Moghunter.v_actor_victory[4] = ["3n0005"];
	//Moghunter.v_actor_victory[5] = ["3la0005"];
	//Moghunter.v_actor_victory[6] = ["3m0005"];
	// -----------------------------------------------------------------------
	// ACTOR - LEVEL UP
	// -----------------------------------------------------------------------		
